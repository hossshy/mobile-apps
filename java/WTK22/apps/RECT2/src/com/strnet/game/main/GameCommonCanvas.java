/*
 * Last modified: 2010/05/17 01:06:56
...
import com.strnet.game.component.PaintUtil;
...
public abstract class GameCommonCanvas extends AbstractCanvas
{
	...
	public void doPaintPressFireKey() throws Exception
	{
		...
		if ( titleCounter < 15 )
		{
			PaintUtil.drawBoldString(this, "PRESS START", 85, 140);
		}
	...
	public void doPaintPressFireKeyDetail() throws Exception
	{
		doPaintTitle();
	}
